...
class UserDefaultsUtility {
    ...
    static func setSignedInStatus(_ flag: Bool) {
        ...
        RootViewManager.shared.isUserLoggedIn = flag
    }
    ...
    static func removeAccessToken() {
        defaults.removeObject(forKey: Constants.accessToken)
    }
    ...
    static func removeUser() {
        defaults.removeObject(forKey: Constants.userModel)
    }
    ...
    static func removeSelectedAddress() {
        defaults.removeObject(forKey: Constants.selectedAddress)
    }
